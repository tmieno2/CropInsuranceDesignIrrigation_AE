...
//------------------
// Premium rate calculation for RP
//------------------
// [[Rcpp::export]]
double premium_calc_RP(
	...
	return premium;
	// //--- premium payment due to the base premium rate ---//
	// double base_premium = base_premium_rate/premium_rate*premium;
	//
	// //--- added premium ---//
	// double added_premium = premium-base_premium;
	//
	// return Rcpp::List::create(
	// 	Rcpp::Named("base_premium")=base_premium,
	// 	Rcpp::Named("added_premium")=added_premium
	// );
}
